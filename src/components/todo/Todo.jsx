...
// console.log(Array)
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const response = await axios.get('https://taskmanagerapprock2.onrender.com/api/tasks', {
          headers: {
  ...
  const createTask = async () => {
    try {
      const response = await axios.post('https://taskmanagerapprock2.onrender.com/api/tasks', Inputs, {
        headers: {
